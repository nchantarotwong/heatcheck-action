...
- Image tags mirror the wrapper's releases: `v1.3.1` (immutable),
...
```sh
docker pull   ghcr.io/nchantarotwong/heatcheck:v1.3.1
docker tag    ghcr.io/nchantarotwong/heatcheck:v1.3.1  internal.registry/security/heatcheck:v1.3.1
docker push   internal.registry/security/heatcheck:v1.3.1
```
