...
- Image tags mirror the wrapper's releases: `v1.0.2` (immutable),
...
```sh
docker pull   ghcr.io/nchantarotwong/heatcheck:v1.0.2
docker tag    ghcr.io/nchantarotwong/heatcheck:v1.0.2  internal.registry/security/heatcheck:v1.0.2
docker push   internal.registry/security/heatcheck:v1.0.2
```
