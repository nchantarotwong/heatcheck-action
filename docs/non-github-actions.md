...
- Image tags mirror the wrapper's releases: `v1.3.0` (immutable),
...
```sh
docker pull   ghcr.io/nchantarotwong/heatcheck:v1.3.0
docker tag    ghcr.io/nchantarotwong/heatcheck:v1.3.0  internal.registry/security/heatcheck:v1.3.0
docker push   internal.registry/security/heatcheck:v1.3.0
```
